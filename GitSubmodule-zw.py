...
if __name__ == '__main__':
	...
	["git submodule add --force https://git.oschina.net/dongfangx/AmazeUI.git src/main/webapp/AmazeUI/", 'v2.4'],
	["git submodule add --force https://git.oschina.net/dongfangx/BJUI.git src/main/webapp/BJUI/", 'v1.0']]
